  ...
  const templateGroups: { kindKey: string; entries: TemplateInput[] }[] = [
    {
      ...
      entries: [
        ...
        { name: "Clothing",       icon: "Shirt",           color: "pink",    featured: true,  sortOrder: 11 },
        { name: "Savings",        icon: "PiggyBank",       color: "emerald", featured: true,  sortOrder: 12 },
        { name: "Subscriptions",  icon: "Smartphone",      color: "purple",  featured: true,  sortOrder: 13 },
        { name: "Transport",      icon: "Car",             color: "orange",  featured: true,  sortOrder: 14 },
        { name: "Utilities",      icon: "Zap",             color: "yellow",  featured: true,  sortOrder: 15 },
      ],
    },
    {
      kindKey: "personal",
