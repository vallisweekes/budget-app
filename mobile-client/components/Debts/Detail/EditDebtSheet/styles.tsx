...
export const styles = StyleSheet.create({
  ...
  sheetCard: { backgroundColor: T.card, height: "88%", position: "relative", borderTopLeftRadius: 24, borderTopRightRadius: 24, borderTopWidth: 1, borderTopColor: T.border, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 150, gap: 14 },
  sheetScroll: { flex: 1, minHeight: 0 },
  sheetScrollContent: { gap: 12, paddingBottom: 12, flexGrow: 1 },
