  ...
  return (
    <div className="space-y-2">
      {incomeItems.map((item) => {
        ...
        if (isEditing) {
          return (
            <div key={item.id} className="flex items-center gap-2 p-2 bg-slate-900/40 rounded-lg border border-white/10">
        ...
        return (
          <div key={item.id} className="flex items-center justify-between group hover:bg-slate-900/20 p-2 rounded-lg transition-colors">
