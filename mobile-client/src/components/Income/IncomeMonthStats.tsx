...
const s = StyleSheet.create({
  ...
  cardLabel: { color: "rgba(255,255,255,0.45)", fontSize: 11, fontWeight: "600", marginBottom: 4 },
  cardValue: { color: "#fff", fontSize: 17, fontWeight: "700" },
  ...
  pillLabel: { color: "rgba(255,255,255,0.4)", fontSize: 11 },
  pillValue: { color: "#fff", fontSize: 11, fontWeight: "700" },
});
