...
export const expenseDetailStyles = StyleSheet.create({
  ...
  headerGlassTint: {
    ...
    backgroundColor: "rgba(22,26,45,0.32)",
  },
  ...
  heroFunding: { color: "rgba(255,255,255,0.88)", fontSize: 13, fontWeight: "700", marginBottom: 16 },
  heroDueBadge: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  bottomGlassTint: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: "rgba(22,26,45,0.24)",
  },
  bottomActionsRow: { flexDirection: "row", gap: 14, justifyContent: "center", alignItems: "center" },
  bottomActionBtn: {
    flex: 1,
  ...
  bottomActionTxt: { fontSize: 16, fontWeight: "800", letterSpacing: 0.1 },
