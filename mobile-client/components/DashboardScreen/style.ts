...
export const styles = StyleSheet.create({
  ...
  aiTipsBody: {
    borderRadius: 18,
    backgroundColor: "rgba(22,28,45,0.56)",
    borderWidth: 1,
    borderColor: "rgba(244,246,255,0.16)",
    padding: 15,
    gap: 10,
  ...
  blueSection: {
    backgroundColor: "rgba(24,31,49,0.58)",
    borderColor: "rgba(244,246,255,0.16)",
  },
  blueSectionTitle: {
    color: T.textDim,
  ...
  netWorthIconEmergency: {
    backgroundColor: "#2d9eff",
  },
  netWorthIconInvest: {
    backgroundColor: "#af5dff",
  },
  netWorthIconSavings: {
    backgroundColor: "#ff8346",
  },
  netWorthIconLiability: {
