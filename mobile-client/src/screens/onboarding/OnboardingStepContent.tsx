...
import { BILL_FREQUENCY_OPTIONS, EXPENSES_TOTAL_BLUE, GOALS, ICON_COLORS, PAY_FREQUENCY_OPTIONS, PLANNING_YEARS_OPTIONS, STEP_ICON_COLORS } from "@/screens/onboarding/utils";
