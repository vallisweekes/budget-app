...
export default async function AdminCategoriesPage() {
  ...
  // Create a map of category IDs to whether they have expenses
    ...
    <div className="min-h-screen pb-20 bg-gradient-to-br from-blue-950 via-slate-950 to-black">
      <div className="mx-auto w-full max-w-7xl px-4 py-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400 text-lg">Organize your expenses with custom categories</p>
        </div>
        ...
        <div className="bg-slate-800/40 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 p-8 mb-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Create a custom expense category</p>
            </div>
          </div>
          <form action={addCategory} className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <label className="md:col-span-2">
              <span className="block text-sm font-medium text-slate-300 mb-2">Featured</span>
              <select
                name="featured"
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Your Categories</h2>
