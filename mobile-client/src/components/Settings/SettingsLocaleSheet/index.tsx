...
export default function SettingsLocaleSheet({ visible, translateY, panHandlers, countryDraft, detectedCountry, saveBusy, onClose, onChangeCountry, onSave }: SettingsLocaleSheetProps) {
  return (
